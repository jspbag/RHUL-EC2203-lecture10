---
pagetitle: EC2203 Nonlinear regression functions
output: 
...
## Tests of the effect of income on test scores
...
# Interaction regression functions
...
## An interaction regression function
...
- **Linear** in coefficients $\beta_0$, $\beta_1$, $\beta_2$, and $\beta_3$, but the effects of $STR$ (and $Income$) are **nonlinear**, as they depend on $Income$ (respectively, $STR$)
